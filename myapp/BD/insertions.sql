...
CALL AddUser('Sudo',      'Employé7',                 'Emp7',   'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --12
CALL AddUser('Sudo',      'Employé8',                 'Emp8',   'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --13
CALL AddUser('Sudo',      'Employé9',                 'Emp9',   'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --14
CALL AddUser('Sudo',      'Employé10',                'Emp10',  'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --15
CALL AddUser('Sudo',      'Employé11',                'Emp11',  'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --16
CALL AddUser('Sudo',      'Employé12',                'Emp12',  'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --17
CALL AddUser('Sudo',      'Employé13',                'Emp13',  'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --18
CALL AddUser('Sudo',      'Employé14',                'Emp14',  'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --19
CALL AddUser('Sudo',      'Employé15',                'Emp15',  'Test123', 0, 1, 23, 1234567890, 'courriel@email.com'); --20
